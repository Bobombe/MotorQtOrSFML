...
Planet::Planet(PlanetType podType, bool left, WorldElement * parent) : Sprite(), _planetType(podType), _cabCaller(0), _freeCab(false)
{
    ...
    case PLANET_PURPLE:
        if (left) {
            setSprite("./Ressources/planets.png", Vector2d(200, 0), Vector2d(200, 600));
        } else{
            setSprite("./Ressources/planets.png", Vector2d(0, 0), Vector2d(200, 600));
        }
    ...
    case PLANET_ORANGE:
        if (left) {
            setSprite("./Ressources/planets.png", Vector2d(600, 0), Vector2d(200, 600));
        } else{
            setSprite("./Ressources/planets.png", Vector2d(400, 0), Vector2d(200, 600));
        }
        setSpeed(Vector2d(0, baseSpeed));
    ...
    case PLANET_GREEN:
        if (left) {
            setSprite("./Ressources/planets.png", Vector2d(1000, 0), Vector2d(200, 600));
        } else{
            setSprite("./Ressources/planets.png", Vector2d(800, 0), Vector2d(200, 600));
        }
        setSpeed(Vector2d(0, baseSpeed));
    ...
    case PLANET_YELLOW:
        if (left) {
            setSprite("./Ressources/planets.png", Vector2d(1400, 0), Vector2d(200, 600));
        } else{
            setSprite("./Ressources/planets.png", Vector2d(1200, 0), Vector2d(200, 600));
        }
        setSpeed(Vector2d(0, baseSpeed));
    ...
    case PLANET_WHITE:
        if (left) {
            setSprite("./Ressources/planets.png", Vector2d(1800, 0), Vector2d(200, 600));
        } else{
            setSprite("./Ressources/planets.png", Vector2d(1600, 0), Vector2d(200, 600));
        }
        setSpeed(Vector2d(0, baseSpeed));
    ...
    case PLANET_BLACK:
        if (left) {
            setSprite("./Ressources/planets.png", Vector2d(2200, 0), Vector2d(200, 600));
        } else{
            setSprite("./Ressources/planets.png", Vector2d(2000, 0), Vector2d(200, 600));
        }
        setSpeed(Vector2d(0, baseSpeed));
