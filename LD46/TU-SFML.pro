...
else:win32:CONFIG(debug, debug|release): stdDllToMove.path = $$OUT_PWD/debug
else:unix: stdDllToMove.path = $$OUT_PWD/release
...
stdDllToMove.files = $$(QTDIR)/bin/libgcc_s_dw2-1.dll $$(QTDIR)/bin/libstdc++-6.dll $$(QTDIR)/bin/libwinpthread-1.dll

INSTALLS += dlls_to_move ressources stdDllToMove
